<template>
	<nav class="navbar navbar-expand-lg bg-vue navbar-dark">
		<div class="container">
			<router-link to="/" class="navbar-brand">Emcore ERP</router-link>
			<ul class="navbar-nav me-auto">
				...
				<li class="nav-item active">
					<router-link to="/BestellungAnlegen" class="nav-link"
						>Bestellungen</router-link
					>
				</li>
				<li class="nav-item active">
					<router-link to="/ArtikelZuordnen" class="nav-link"
						>Artikel Zuweisen</router-link
					>
				</li>
			</ul>
